<section
  class="bg-navy md:bg-transparent text-cloud md:absolute z-20 md:w-auto md:left-1/2 md:-translate-x-1/2 md:bottom-72 animate-[fade-in_700ms_1500ms_ease-out_both]">
  <x-layout.inner class="p-30 pt-0 md:p-0">
    <div class="grid grid-cols-2 gap-20 md:flex md:flex-row md:gap-60 md:justify-center md:items-start">
